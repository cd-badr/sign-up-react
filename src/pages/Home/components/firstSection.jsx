...
export const FirstSection = () => {
    return (
        <>
        <div className="w-[500px]  bg-slate-50 rounded-xl flex justify-center items-center justify-evenly flex-col p-10 gap-10">
            <h1 className='text-3xl border-b-2 border-zinc-300 w-full pb-3 text-center'>Login</h1>
            ...
            <button className='text-[#4f8399]'>Register</button>
            </div>
        </div>
